const EmailTemplates3 = () => {
    return (
      <div className="w-[640px] bg-white mx-auto my-10 shadow-lg rounded-lg overflow-hidden flex flex-col items-center p-12 font-['Stack_Sans_Headline'] text-center">
        ...
        <div className="flex flex-col items-center gap-3 mb-8 w-full px-10">
          <p className="text-[#444444] text-[12px] font-normal">
            To reset your password, please click the link below:
          </p>
          <a
            href="https://app.yourproduct.com/auth/verify?email=user@example.com&code=839201"
            className="text-[#0352FD] text-[12px] font-normal break-all hover:underline"
          >
...
export default EmailTemplates3