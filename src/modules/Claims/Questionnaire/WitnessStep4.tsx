...
const Step4Canvas = () => {
  ...
  const getSketchImage = () => {
    const canvas = canvasRef.current;
    if (!canvas) return "";
    return canvas.toDataURL("image/png");
  };

  const saveSketchToState = () => {
      ...
      <div className="w-full px-10 py-3 bg-white shadow-md flex justify-between items-center z-10">
        ...
        <div className="flex items-center gap-10">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => navigate(-1)}
              className="px-8 py-4 border border-blue-600 text-blue-600 rounded"
            >
              Cancel
            </button>
            ...
            <button
              ...
              className="px-8 py-4 border border-blue-600 text-blue-600 rounded font-weight-400"
            >
              Save Sketch
            </button>
