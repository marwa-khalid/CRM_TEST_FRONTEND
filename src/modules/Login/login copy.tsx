...
const [scale, setScale] = useState(1);
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      const baseHeight = 903; // This is the 'min-h' you mentioned earlier
      
      const windowWidth = window.innerWidth;
      const windowHeight = window.innerHeight;

      // Calculate the ratio for both dimensions
      ...
      // We use Math.min to ensure we don't zoom IN past 100% (unless you want that)
    ...
    <div className="w-full h-screen overflow-hidden flex justify-center items-center">
      <div
        ...
        style={{
          ...
          transformOrigin: "center center", // Changed from 'top left' to keep it centered
          minWidth: "1600px",
          height: "903px", // Use a fixed height so scale works correctly
