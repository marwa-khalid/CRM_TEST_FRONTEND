...
//                 if (place.name) {
//                   setWitness({ ...witness, address: place.address });
//                   setWitness({ ...witness, postCode: place.postalCode });
...
//             className="px-6 py-4 bg-blue-600 text-white rounded font-weight-400 hover:bg-blue-700 transition-flex items-center gap-2"
//           >
//             Send Questionnaire
//           </button>
//         </div>
