        ...
        <ContextWrapper>
            <AriaCalendar {...props} className={(state) => cx("flex bg-white flex-col gap-3", typeof className === "function" ? className(state) : className)}>
                ...
                <div className="flex gap-3">
                    <DateInput className="flex-1 font-sans" />
                    ...
                    <AriaCalendarGridHeader className="border-b-4 border-transparent">
                        {(day) => (
                            <AriaCalendarHeaderCell className="p-0">
                                <div className="flex size-10 items-center justify-center text-sm font-medium text-secondary bg-white">{day.slice(0, 2)}</div>
