...
//               styles={customStyles}
//               onChange={(val) => updateField("claimType", val.value)}
//               components={{
...
//               onChange={(val) => updateField("handler", val.value)}
//               components={{
//                 DropdownIndicator: BlueDropdownIndicator,
//                 IndicatorSeparator: () => null,
//               }}
...
//               onChange={(val) => updateField("targetDebt", val.value)}
//               components={{
//                 DropdownIndicator: BlueDropdownIndicator,
//                 IndicatorSeparator: () => null,
//               }}
...
//               onChange={(val) => updateField("findUsSource", val.value)}
//               styles={customStyles}
//               components={{
//                 DropdownIndicator: BlueDropdownIndicator,
//                 IndicatorSeparator: () => null,
...
//                 onChange={(val) => updateField("staffMemberName", val.value)}
//                 components={{
//                   DropdownIndicator: BlueDropdownIndicator,
//                   IndicatorSeparator: () => null,
//                 }}
...
//               onChange={(val) => updateField("caseStatus", val.value)}
...
//               onChange={(val) => updateField("nonFault", val.value)}
//               components={{
//                 DropdownIndicator: BlueDropdownIndicator,
//                 IndicatorSeparator: () => null,
//               }}
...
//               onChange={(val) => updateField("passengers", val.value)}
//               components={{
//                 DropdownIndicator: BlueDropdownIndicator,
//                 IndicatorSeparator: () => null,
//               }}
...
//               onChange={(val) => updateField("clientInjured", val.value)}
//               components={{
//                 DropdownIndicator: BlueDropdownIndicator,
//                 IndicatorSeparator: () => null,
//               }}
...
//               onChange={(val) => updateField("prospects", val.value)}
...
//             onChange={(val) => updateField("presentPosition", val.value)}
//             components={{
//               DropdownIndicator: BlueDropdownIndicator,
//               IndicatorSeparator: () => null,
//             }}
...
import { notifyManager } from "../../../services/Client/Client";
import { setClaimId, setIsClosed } from "../../../redux/Claim/claimSlice";
import { CustomDatePicker } from "../Components/DatePicker";
...
useEffect(() => {
  ...
  return (
    <div className="MainContent w-[788px] ms-[140px] flex-1 inline-flex flex-col items-start gap-6 p-8 overflow-y-auto scrollbar-hide">
      <h1 className="text-black text-2xl font-semibold">General Details</h1>
      ...
      <div className="w-full flex flex-col gap-6">
            ...
            {formik.values.source_id === 3 && (
              <div className="col-span-2 flex flex-col gap-2 animate-in fade-in duration-300">
                ...
                <Select
                  ...
                  options={handlerOptions}
                  value={handlerOptions.find(
                    (option) => option.value === formik.values.source_staff_user_id,
                  )} // Controlled from step1Data
                  onChange={(val) =>
        ...
        <div className="PositionSection p-5 self-stretch rounded-lg border border-gray-100 flex flex-col gap-4">
          <div className="flex justify-between items-center">
            ...
            <button
              type="button"
              onClick={() => setShowCloseModal(true)}
              className="flex gap-1 items-center px-4 py-2 bg-blue-50 text-blue-600 rounded-md font-medium text-sm"
            >
        ...
        <div className="PresentFilePositionSection p-5 rounded-lg border border-gray-100 flex flex-col gap-4 mb-10">
          ...
          <div className="w-[384px] flex flex-col gap-2">
            ...
            <Select
              ...
              value={positionOptions.find(
                (option) => option.value === formik.values.present_position_id,
              )}
              onChange={(val) =>
          ...
          <div className="flex gap-10 items-start">
            ...
            {formik.values.client_going_abroad && (
              <div
                className="w-[384px] flex flex-col gap-2 relative"
                ref={containerRef}
              >
                <label className="text-gray-700 text-sm font-medium">
                  Date
      ...
      {showCloseModal && (
        <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex justify-center items-center z-50">
          <div className="ModalInput p-6 bg-white rounded-lg shadow-xl inline-flex flex-col gap-5">
            <h2 className="text-xl font-semibold">Close File</h2>
            <textarea
