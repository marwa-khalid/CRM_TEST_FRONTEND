...
export const TableRowActionsDropdown = ({onDelete, onEdit}) => (
    <Dropdown.Root>
  <Dropdown.DotsButton className="focus:outline-none focus:ring-none" />

  <Dropdown.Popover className="w-min focus:outline-none focus:ring-none">
    <Dropdown.Menu className="focus:outline-none focus:ring-0">
      <Dropdown.Item
        icon={Edit01}
        className="hover:bg-gray-100 focus:outline-none focus:ring-none"
        onClick={onEdit}
      >
      ...
      <Dropdown.Item
        icon={Trash01}
        className="text-red-500 hover:bg-gray-100 focus:outline-none focus:ring-none"
        onClick={onDelete}
      >
        ...
        >
            <div className="flex flex-1 flex-col gap-0.5">
                <div className="flex items-center gap-2">
                    <h2 className={cx("font-weight-600 text-primary", size === "sm" ? "text-md" : "text-lg")}>{title}</h2>
                    {badge ? (
            ...
            {(state) => (
                <AriaGroup className="flex items-center gap-1">
                    <div className="flex items-center gap-1">
                        {label && <span className="text-xs font-weight-600 whitespace-nowrap text-quaternary">{label}</span>}
