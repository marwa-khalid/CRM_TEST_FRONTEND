    ...
    <div className="w-full h-screen overflow-hidden flex justify-center items-center bg-white font-['Stack_Sans_Headline']">
      ...
      >
        ...
        <div className="flex flex-col w-[508px] items-start gap-10 absolute top-[197px] left-[810px]">
          <h2 className="relative self-stretch text-neutral-900 text-[24px] font-weight-600 leading-[24px] break-words">
            Account Locked
          </h2>
          ...
          >
            <div className="flex flex-col items-start justify-start w-full max-w-[508px] gap-1">
              ...
              <div className="flex items-start justify-start w-full gap-5 rounded-[4px]">
                ...
                <p className="w-[440px] text-neutral-700 text-[16px] font-weight-400 leading-tight break-words">
              ...
              <div className="flex items-start justify-start w-full gap-5 py-3 rounded-[4px]">
                ...
                <div className="text-left leading-tight">
                  <p className="w-[440px] text-neutral-700 text-[14px] font-weight-400 leading-tight break-words">
                    Try Login again or reset your password if you’ve forgotten
                    it. If the issue continues, please contact your system
                    administrator.
                  </p>
                </div>
              </div>
            ...
            className="relative self-stretch font-CTA-link text-primary text-[14px] text-primary tracking-[var(--CTA-link-letter-spacing)] leading-[var(--CTA-link-line-height)] [font-style:var(--CTA-link-font-style)] text-left cursor-pointer hover:underline"
          >
            Forgot Password
          </button> */}
            <div className="flex items-start justify-start gap-[24px]">
              ...
              >
                <span className="text-primary text-[16px] font-weight-500 leading-[16px] group-hover:text-white transition-colors">
                  Reset Password
                </span>
              </button>
