...
export const FileUploadDropZone = ({
    ...
    >
        <span className="font-bold" style={{ color: '#252B37' }}><b>Click to upload</b></span>  <span className="md:hidden">and attach files</span>
    </Button>
</label>
<span className="text-sm max-md:hidden mt-[9px] ml-[-11px]">or drag and drop</span>
        ...
        >
            ...
            <div className="flex min-w-0 flex-1 flex-col items-start">
                <div className="flex w-full max-w-full min-w-0 flex-1">
                    ...
                    <ButtonUtility color="tertiary" icon={Trash01} size="xs" className="-mt-2 -mr-2 self-start" onClick={onDelete} />
                </div>

                {!failed && (
                    <div className="mt-1 w-full">
                        <ProgressBar labelPosition="right" max={100} min={0} value={progress} progressClassName="bg-custom" className="bg-gray-200" />
                    </div>
                )}
